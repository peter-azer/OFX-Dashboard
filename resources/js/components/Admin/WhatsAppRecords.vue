          ...
          <v-list>
            ...
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-subtitle>{{ selectedItem.contact?.whatsapp || 'N/A' }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
            <v-list-item>
              <v-list-item-content>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'WhatsApp Number', value: 'contact_whatsapp' },
  ...
  computed: {
    recordsWithContactInfo() {
      return this.records.map(record => {
        const contact = record.whats_app_contact || {};
        return {
          ...record,
          contact_name: contact.name || 'Unknown',
          contact_whatsapp: contact.phone || 'N/A',
          contact: contact
        };
      });
    }
